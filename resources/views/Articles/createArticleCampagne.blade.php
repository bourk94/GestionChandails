...
@if (Auth::user()->type == 'admin')
    @if (count($articles))
        <div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
            ...
            <form class="w3-container" id="my-form" action="{{ route('articles.storeArticleCampagne') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="w3-section">
                    ...
                    <select class="w3-input w3-border w3-hover-border-black" style="width:100%;" name="article_id" id="article_id">
                ...
                <div class="w3-section">
                    ...
                    <input type="file" class="@error('image') is-invalid @enderror w3-input w3-border w3-hover-border-black" style="width:100%;" name="image" id="image">
                    @error('image')
                ...
                <div class="w3-section">
                    ...
                    <input type="number" class="@error('prix') is-invalid @enderror w3-input w3-border w3-hover-border-black" style="width:100%;" name="prix" id="prix" min="0">
                    @error('prix')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    @if (count($tailles))
                        ...
                        <select class="w3-input w3-border w3-hover-border-black" style="width:100%;" name="taille_id" id="taille">
                ...
                <div>
                    ...
                    <input class="@error('quantite_max') is-invalid @enderror w3-input w3-border w3-hover-border-black" style="width:100%;" type="number" name="quantite_max" id="quantite_max" min="0" placeholder="Valeur par défaut est 5">
                    @error('quantite_max')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <button type="submit" class="w3-button w3-block w3-hover-red btnColor">Ajouter un article à la campagne</button>
            </form>
