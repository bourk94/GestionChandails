    ...
    <div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
        ...
        <form class="w3-container" action="{{ route('articles.storeArticle') }}" method="POST">
            ...
            <div class="w3-section">
                ...
                <input class="@error('nom') is-invalid @enderror w3-input w3-border w3-hover-border-black" type="text"
                    name="nom" id="nom">
                @error('nom')
                ...
                <select class="@error('type') is-invalid @enderror w3-input w3-border w3-hover-border-black" name="type"
                    id="type">
                ...
                <textarea class="@error('description') is-invalid @enderror w3-input w3-border w3-hover-border-black" name="description"
                    class="description" id="description"></textarea>
                @error('description')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
