                    ...
                    <form class="w3-container" id="my-form"
                        ...
                        <div>
                            @if (count($couleurs))
                                ...
                                @endforeach
                                <select class="w3-input w3-border w3-hover-border-black" style="width:100%;"
                                    name="couleur_id" id="couleur">
                        ...
                        <div>
                            ...
                            <input
                                class="@error('quantite_max') is-invalid @enderror w3-input w3-border w3-hover-border-black"
